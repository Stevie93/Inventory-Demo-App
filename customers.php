...
<div class="hero-body" style="padding-top:80px;">	
  <div class="container">
    <table class="table is-fullwidth is-striped is-hoverable">
      <thead>
        <tr>
          <th><abbr title="Vendor Name">Customer</abbr></th>
 <!--         <th>Reference</th> -->
          <th>Phone</th>
          <th>Timestamp</th>
        </tr>
...
$query = "SELECT * FROM customer WHERE product='customer' ORDER BY reg_date DESC";
$result1 = mysqli_query($conn, $query);
  ...
  /*               if ($row['outstanding']>0){
      ...
      <div class="field is-grouped is-grouped-centered">
        ...
        <p class="control"><a href="form.php" class="button is-info is-small">New Record</a></p>
        </p>
      </div>
