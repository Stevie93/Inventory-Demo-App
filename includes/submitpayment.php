...
$pay = $name = $result = $phone = $item = $amount = $message = $clientname = $product = $outstanding = $reference = $comment = $year = $received = $gatein = $gateout ='';
...
echo "the id is ".$passid;

// $id = 8;

	$sql = "UPDATE storage SET paid = $paid where storage.id= $passid ;";
